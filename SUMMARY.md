...
- [OAM Specs(中文)](cn/README.md)
  ...
  - [应用范围（Application Scopes)](5.application_scopes.md)
  - [特性（Traits)](6.traits.md)
  - [应用（Application Scopes）](7.application.md)
  - [实现考量](8.practical_considerations.md)
  - [设计原则](9.design_principles.md)
